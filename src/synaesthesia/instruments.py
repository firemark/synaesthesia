...
INSTRUMENTS_LIST = [(id, label) for id, label in INSTRUMENTS.items()]
INSTRUMENTS_LIST.sort()
INSTRUMENTS_LIST = [label for _, label in INSTRUMENTS_LIST]
INSTRUMENTS_REVERSE = {label: id for id, label in INSTRUMENTS.items()}